...
class RIAssistant:
    def __init__(self, directory_path: str = "./r&i_assistant_docs", pinecone_namespace: str, pinecone_index: str):
        load_dotenv()
        ...
        self._pinecone_index = "ri-assist"
        self._pinecone_namespace = "" # vectorstore.add_documents upserts docs w/o namespace
    ...
    def _process_directory(self, directory_path: str) -> list:
    ...
    def _build_directory_document(self, file_path: str, loader: object) -> Document:
    ...
    def _build_github_doc(self, repo_name: str, gitdoc: list) -> Document:
